...
const sections = [
  ...
  {
    title: '취소 및 환불',
    body: '환불 금액은 총 결제 금액을 기준으로 입실일까지 남은 일수에 따라 산정됩니다. 이용 15일 전 취소 시 전액 환불되며, 이용 2일 전~당일 취소는 환불이 불가합니다. 성수기(여름 7/15~8/24, 겨울 12/1~1/15)는 별도 수수료 기준이 적용됩니다. 날짜 변경은 이용 10일 전까지만 가능하며, 이후 요청은 취소 후 재예약으로 처리됩니다. 노쇼(No-Show) 시 환불이 절대 불가하며, 기상 악화로 인한 교통 결항 시 증빙 서류 제출 후 100% 환불 또는 날짜 변경이 가능합니다.',
  },
  {
    title: '고지 사항',
