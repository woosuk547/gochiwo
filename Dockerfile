...
ARG NEXT_PUBLIC_CHANNEL_PLUGIN_KEY
...
ENV NEXT_PUBLIC_CHANNEL_PLUGIN_KEY=$NEXT_PUBLIC_CHANNEL_PLUGIN_KEY
...
RUN printf '%s\n' \
  ...
  "NEXT_PUBLIC_CHANNEL_PLUGIN_KEY=${NEXT_PUBLIC_CHANNEL_PLUGIN_KEY}" \
  > .env.production
