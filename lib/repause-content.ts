...
export const guideFaq = [
  ...
  },
  {
    ...
    answer: '리포즈의 모든 실내 공간과 야외 테라스, 데크를 포함한 전 구역은 완전한 금연(전자담배 포함) 구역이에요. 다음 분을 위한 맑은 공기를 유지할 수 있도록 흡연은 삼가해 주시기 바라며, 위반 사항이 지속될 시에는 다음 여정을 모시는 분들을 위한 정화 딥클리닝 대금이 정산될 수 있으며, 품격 있는 이용을 보존하기 위해 조기 가이드 조치가 내려질 수 있습니다.',
  },
  {
