...
export const primaryStay = {
  ...
  description: '전면창 거실, 자쿠지, 프라이빗 데크. 세상의 알람을 끄고 자연의 숨소리에 주파수를 맞추는 하이엔드 독채 스테이입니다.',
  fromPrice: '680,000원~',
...
export const signatureHighlights = [
  ...
  {
    title: '자쿠지',
    description: '여유로운 자쿠지에서 천천히 몸을 담그는 반신욕. 하루의 긴장이 조용히 풀리는 섬세한 쉼의 흐름입니다.',
  },
  {
    title: '포치 아래 명상',
...
export const homeSignatureFacts = [
  ...
  { title: '이용 인원', desc: '기준 4인 · 최대 4인', detail: '2인 · 4인 예약' },
...
export const amenityGroups = [
  ...
  {
    title: '야외 · 안전',
    items: ['사계절 전용 풀 (지하수)', '프라이빗 데크', '소화기'],
  },
]
...
export const guideGroups = [
  ...
  { title: '공간 이용 수칙', items: ['기준 4인 · 최대 4인 (2인 · 4인 예약)', '반려동물 동반 불가', '실내 전 구역 금연. 사적 파티 및 예약 정원 외 인원 출입 제한'] },
...
export const reservationSteps = [
  ...
  { step: '2', title: '인원 입력', copy: '2인 · 4인 중 머무실 인원과 요청사항을 남겨주세요.' },
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            answer:
              '기준 인원과 최대 인원은 모두 4인입니다. 숙박 인원은 2인 또는 4인으로 예약할 수 있어요.\n\n3인 투숙 시에는 4인으로 예약해 주세요. 4인까지는 추가 인원 요금이 없어요.\n\n4인을 넘는 인원은 예약할 수 없으며, 사전 협의 없는 초과 인원이 확인되면 입실이 제한될 수 있어요.',
          },
        ],
      },
      {
