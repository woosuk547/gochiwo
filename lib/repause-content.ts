        ...
        items: [
          {
            ...
            answer:
              '일반/비수기: 이용 10일 전까지는 100% 환불이 가능합니다. 이용일 3일 전~당일은 환불이 불가합니다.\n\n성수기 및 공휴일: 예약이 집중되는 기간에는 이용 15일 전까지만 100% 환불이 가능하며, 이후에는 기간에 따라 위약금이 발생하오니 신중한 예약을 부탁드립니다.\n\n자세한 사항은 아래 환불 규정 표를 참고해 주시기 바랍니다.',
          },
          {
